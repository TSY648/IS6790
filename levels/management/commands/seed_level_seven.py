    ...
    def handle(self, *args, **options):
        ...
        items = [
            ...
            },
            {
                ...
                'content_json': {
                    ...
                    'rows': [
                        ...
                        ['Delivery app B', 'B-120103', '2026/03/28 20:58', 'Eggs', '1', 'pcs', '$0.40'],
            ...
            },
            {
                ...
                'content_type': 'text',
                'content_text': "Cleanup Protocol: We can't trust the math until the data is clean. Step 1: Scrub the duplicate rows. Step 2: Normalize the unit of 'egg' into 'pieces'. Step 3: Normalize the unit of 'wings' into 'portion'. Step 4: Normalize the unit of 'strawberry' into 'kg'. Once the sheet is standardized, the real profit story will finally reveal itself.",
                'is_key_item': True,
                'sort_order': 3,
            },
            {
